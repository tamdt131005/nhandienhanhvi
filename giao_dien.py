    ...
    def init_models(self):
        ...
        try:
            if PhatHienBuonNgu:
                ...
                # Tạo alias nếu thiếu hàm xu_ly_frame
                if not hasattr(self.phat_hien_buon_ngu, 'xu_ly_frame') and hasattr(self.phat_hien_buon_ngu, 'xu_ly_frame_chinh'):
                    self.phat_hien_buon_ngu.xu_ly_frame = self.phat_hien_buon_ngu.xu_ly_frame_chinh
